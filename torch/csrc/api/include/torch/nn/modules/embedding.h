...
class TORCH_API EmbeddingBagImpl : public torch::nn::Cloneable<EmbeddingBagImpl> {
 public:
  ...
  Tensor forward(const Tensor& input, const Tensor& offsets = {}, const Tensor& per_sample_weights = {}, bool lookup_mode = false, bool use_dpu = false, uint64_t num_of_tables = 0, uint64_t dpu_set_ptr = 0);
